...
class DatasetCreator(object):
    ...
    def createDataset(self,params,filename,filterGenre=None, goids=None):
        ...
        for sh in gamesShot:
            ...
            if s != None:
                line += str(gamesId[i])+","
                if gamesShot[i] == "0990bda0cb0db8f45a4badfe63aaa783baf430bf":
                    print gamesShot[i],gamesId[i],s["code"]
...
def main():
    ...
    #Oficial
    dsc.createDataset('dataset_exp3.json','base_oficial_final_v2.csv')
